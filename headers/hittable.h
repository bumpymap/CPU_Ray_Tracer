...
public:
    ...
    void set_face_normal(const ray& r, const glm::dvec3& outword_normal) {
...
public:
    translate(shared_ptr<hittable> object, const glm::dvec3& offset) : object(object), offset(offset) {
